...
const ProductTags = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/api/producttags')
    ...
    return (
        <>
            <div className="wrapper-productTags">
                <div className="sort">
                    <p className="info-home"><Link to="/"><FontAwesomeIcon className='icon-home' icon={faHome} /></Link>/Bộ sưu tập</p>
